		...
		<nav class="navbar navbar-expand-lg navbar-light navbar-expand-md">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav">
                ...
                <li class="nav-item">
                  <a class="nav-link " href="http://localhost:8080/MyhotelMam/admin/Login.jsp">Login</a>
                </li>
              </ul>
            </div>
            ...
            <div class="row justify-content-left">
              <div class="col-md-8">
                  ...
                  <form action="../adminlogin"  method="post">
                      ...
                      <input  type="submit" class="button btn btn-outline-dark" Sign In>
                  </form>
              </div>        
            </div>
            
        </div>
        <div class ="contaoner w-50 p-3 m-5">
