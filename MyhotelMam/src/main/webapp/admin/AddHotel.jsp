              ...
              <form action="../addhotel"  method="post">
                  <div class="row mb-3">
                      <div class="col">
                          ...
                          <input name="hotelname" type="text" class="form-control"  placeholder="Hotel Name" required >
                      </div >
                      <div class="col">
                  ...
                  <div class="row mb-3">
                      ...
                      <div class="row mb-3">
                      <div class="col">
                          <label for="totalnoofroom" class="form-label">TotaNoofRoom :</label>
                          <input name="totalnoofroom" type="text" class="form-control"  placeholder="Enter Address"  required >
                      </div>
                      <div class="col">
                  ...
                  <!-- <a  id="btn" class="button btn btn-outline-dark">Create Account</a> -->
              </form>
          </div>        
        </div>
      </div>
