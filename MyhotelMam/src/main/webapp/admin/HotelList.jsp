...
body {
	...
	padding: 0;
	background-image:
		url("http://localhost:8080/MyhotelMam/img/Owall-Hotel-Seoul-Exterior.jpeg");
...
<body>
		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="navbar-nav">
				<li class="nav-item active"><a class="nav-link "
					href="Home1.html">Home</a></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-bs-toggle="dropdown" aria-expanded="false">
						Hotels </a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item" href="AddHotel.jsp">Add
								Hotel</a></li>
						<li><a class="dropdown-item" href="HotelList.jsp">Hotel
								List</a></li>
					</ul></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-bs-toggle="dropdown" aria-expanded="false">
						Users </a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item" href="AddUsers.html">Add
								Users</a></li>
						<li><a class="dropdown-item" href="UsersList.html">User
								List</a></li>
					</ul></li>
				<li class="nav-item dropdown"><a
					class="nav-link dropdown-toggle" href="#" id="navbarDropdown"
					role="button" data-bs-toggle="dropdown" aria-expanded="false">
						Booking </a>
					<ul class="dropdown-menu" aria-labelledby="navbarDropdown">
						<li><a class="dropdown-item" href="BookingList.html">Booking
								List</a></li>
					</ul></li>
	...
	%>
	<center style="color: green">hotel added Sesfully</center>

	<%
	} else if (update.equals("update")) {
	%>
	<center>
		<h2>Hotel Edit sesfully</h2>
	</center>
	<%
	}}
	%>
	...
	List<Hotel> hotels = dao.getAllHotelDetl();
	if (hotels != null) {
	%>
	...
	<div class="container">
		...
		<form action="">
			<table class="table ">
				...
				<tbody>
					...
					<tr>
						...
						<td><a
							href="/MyhotelMam/admin/EditHotel.jsp?hotelId=<%=hotel.getId()%>"
							id="btn" class="button btn btn-outline-dark">Update</a> &nbsp; <a
							href="/MyhotelMam/deleteh?id=<%=hotel.getId()%>" id="btn"
							class="button btn btn-outline-dark">Delete</a></td>
					</tr>
					<%
					}
					%>
			...
			%>
			<center>
				<h1 style="color: red">hote not found</h1>
			</center>
			<%
			}
			%>
