...
<%@page import="org.jsp.dao.AdminDaoImp"%>
...
<nav class="navbar navbar-expand-lg navbar-light navbar-expand-md">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                      ...
                      <li><a class="dropdown-item" href="/UserList.jsp">User List</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
    ...
    <div class="container  w-50 p-3 m-5">
              ...
              <form action="../UpdateHotel"  method="post">
                  <div class="row mb-3">
                      <div class="col">
                          ...
                          <input type="text" class="form-control" name="hotelNmae"  value="<%=hotel.getHotelName() %>" required >
                      </div>
                      <div class="col">
                          <label for="contact" class="form-label">Contact Number :</label>
                          <input type="text" class="form-control" name="contact" value="<%=hotel.getMobile() %>"   required >
                      </div>
                  </div>
                  <div class="row mb-3">
                      <div class="col">
                          <label for="price" class="form-label">Price :</label>
                          <input type="number" class="form-control"  name="price" value="<%=hotel.getPrice() %>"  required >
                      </div>
                      <div class="col">
                        <label for="city" class="form-label">City :</label>
                        <input type="text" class="form-control" name ="city" value="<%=hotel.getCity() %>" required >
                    </div>	
                  </div>
                  <div class="row mb-3">
                      <div class="col">
                          <label for="address" class="form-label">Address :</label>
                          <input type="text" class="form-control"  name="address" value="<%=hotel.getAddress() %>"  required >
                      </div>
                      <div class="row mb-3">
                      <div class="col">
                          <label for="address" class="form-label">total no of room:</label>
                          <input type="text" class="form-control"  name="tnoofRoom" value="<%=hotel.getTotalNoOfRoom() %>"  required >
                      </div>
                      <div class="row mb-3">
                      <div class="col">
                          <label for="address" class="form-label">booked room :</label>
                          <input type="text" class="form-control"  name="bkroom" value="<%=hotel.getNoOfBookedRoom() %>"  required >
                      </div>
                      <div class="col">
                    ...
                    <div>
                    	<input type="number" hidden value="<%=hotel.getId() %>" name="id">
                    </div>
                  </div>
                   <button type="submit" class="btn btn-outline-dark">EditHotel</button> 
      ...
      <%}else{ %>
      <center><h2 style="color: red">invalid id </h2></center>
      <%} %>
