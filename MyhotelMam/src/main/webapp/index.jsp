...
<body>
    ...
    <div>
        ...
        <center>
        <br><br>
        <a href="http://localhost:8080/MyhotelMam/admin/Login.jsp"> bu<button id="btn" class="button btn btn-outline-dark">Admin</button></a>
        
        <br> <br>
         <a href="http://localhost:8080/MyhotelMam/user/Login.jsp"> bu<button id="btn" class="button btn btn-outline-dark">user</button></a>
     
         <a href="http://localhost:8080/MyhotelMam/user/SighUp.jsp"> bu<button id="btn" class="button btn btn-outline-dark">Customer</button></a>
        </center>
    </div>
</body>
</html>